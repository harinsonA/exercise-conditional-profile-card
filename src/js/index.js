...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "Nombres";
  if (variables.lastname == null) variables.lastname = "Apellidos";
  if (variables.role == null) variables.role = "Seleccione una profesion";
  if (variables.city == null) variables.city = "Selecione una Ciudad";
  if (variables.country == null) variables.country = "Selecione un Pais";

  if (variables.socialMediaPosition == "Left") {
    variables.socialMediaPosition = "class='position-left'";
  } else if (variables.socialMediaPosition == "Right") {
    variables.socialMediaPosition = "class='position-right'";
  }
